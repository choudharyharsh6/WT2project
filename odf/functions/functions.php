...
$mail->Username = 'oes.onlineexams@gmail.com';                 // SMTP username
$mail->Password = 'oes@12345';                           // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to


$mail->setFrom('oes.onlineexams@gmail.com', 'Online Discussion Forum');
...
$mail->setFrom('oes.onlineexams@gmail.com', 'PESU Discussion Forum');
$mail->addAddress($email);  
$mail->addReplyTo('no-reply@gmail.com', 'Np-reply');
